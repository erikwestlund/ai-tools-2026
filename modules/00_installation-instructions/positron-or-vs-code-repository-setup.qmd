...
Use this if you are using Positron or VS Code for the course. The screenshots show Positron, but the workflow is the same in VS Code.
...
```text
table-and-visualization.code-workspace
```
